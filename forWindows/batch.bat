...
FOR /F "tokens=" %%A IN ('adb shell ls /sdcard/DCIM/Camera/*.jpg 2^>NUL') DO (
    ...
    curl -X POST http://CAPSTONE-URL/api/upload ^
    -H "Content-Type: application/json" ^
    -d "{\"file_path\": \"C:\\test\\Camera\\!RESULT!\", \"folder_path\": \"/sdcard/DCIM/Camera\"}"
)
...
if "%FOLDER_EXISTS%"=="exists" (
    ...
    FOR /F "tokens=" %%A IN ('adb shell ls /sdcard/DCIM/Camera/SNOW/*.jpg 2^>NUL') DO (
        ...
        curl -X POST http://CAPSTONE-URL/api/upload ^
        -H "Content-Type: application/json" ^
        -d "{\"file_path\": \"C:\\test\\Camera\\!RESULT!\", \"folder_path\": \"/sdcard/DCIM/Camera/SNOW\"}"
    )
) ELSE (
...
FOR /F "tokens=" %%A IN ('adb shell ls /sdcard/Android/data/com.sec.android.gallery3d/files/.Trash/*.jpg 2^>NUL') DO (
    ...
    curl -X POST http://CAPSTONE-URL/api/upload ^
    -H "Content-Type: application/json" ^
    -d "{\"file_path\": \"C:\\test\\Trash\\!RESULT!\", \"folder_path\": \"/sdcard/Android/data/com.sec.android.gallery3d/files/.Trash\"}"
)
...
FOR /F "tokens=" %%A IN ('adb shell ls /sdcard/Android/data/com.snowcorp.soda.android
/files/temp/*.jpg 2^>NUL') DO (
    SET "FILE=%%A"
    FOR /F "delims=" %%B IN ('echo !FILE!') DO (
        SET "FILE=%%B"
    )
    ...
    curl -X POST http://CAPSTONE-URL/api/upload ^
    -H "Content-Type: application/json" ^
    -d "{\"file_path\": \"C:\\test\\Soda_cache\\!RESULT!\", \"folder_path\": \"/sdcard/Android/data/com.snowcorp.soda.android/files/temp\"}"
)
